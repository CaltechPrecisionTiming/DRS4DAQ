...
int main (int argc, char **argv)
{
  ...
  //----------------------------------
  //TTree to hold timing analysis data
  //----------------------------------
  ...
  //------------------------------
  //Setting up addresses for TTree
  //------------------------------
  ...
  if (includePulseshapeInOutput) {
    ...
    treeOut->Branch("c1",c1,"c1[1024]/F");
    treeOut->Branch("c2",c2,"c2[1024]/F");
    treeOut->Branch("c3",c3,"c3[1024]/F");
    treeOut->Branch("c4",c4,"c4[1024]/F");
    
    treeOut->Branch("t1",t1,"ti1[1024]/F");
    treeOut->Branch("t2",t2,"ti2[1024]/F");
    treeOut->Branch("t3",t3,"ti3[1024]/F");
    treeOut->Branch("t4",t4,"ti4[1024]/F");
  }
...
//          cout<<"v_RMS["<<j<<"] : "<<v_RMS[j]<<endl;
      ...
      treeOut->Fill();//Fill new tree output
